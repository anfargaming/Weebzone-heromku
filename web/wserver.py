...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://t.me/KCFilmss"><i class="fab fa-telegram"></i></a>
        <a href="https://t.me/KCxTG"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>Join <a href='https://t.me/KCFilmss'>@KCFilmss</a> By <a href='https://t.me/KCxTG'>KCxTG</a></h1>"
