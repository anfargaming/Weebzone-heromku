...
def speedtest(update, context):
    ...
    string_speed = f'''
╭─《 🚀 SPEEDTEST INFO 》
├ <b> ▫️ Upload:</b> <code>{speed_convert(result['upload'], False)}</code>
├ <b> ▫️ Download:</b>  <code>{speed_convert(result['download'], False)}</code>
├ <b> ▫️ Ping:</b> <code>{result['ping']} ms</code>
├ <b> ▫️ Time:</b> <code>{result['timestamp']}</code>
...
├ <b> ▫️ Sponsor:</b> <code>{result['server']['sponsor']}</code>
├ <b> ▫️ Latency:</b> <code>{result['server']['latency']}</code>
├ <b> ▫️ Latitude:</b> <code>{result['server']['lat']}</code>
╰ <b> ▫️ Longitude:</b> <code>{result['server']['lon']}</code>

╭─《 👤 CLIENT DETAILS 》
├ <b> ▫️ IP Address:</b> <code>{result['client']['ip']}</code>
├ <b> ▫️ Latitude:</b> <code>{result['client']['lat']}</code>
├ <b> ▫️ Longitude:</b> <code>{result['client']['lon']}</code>
├ <b> ▫️ Country:</b> <code>{result['client']['country']}</code>
├ <b> ▫️ ISP:</b> <code>{result['client']['isp']}</code>
