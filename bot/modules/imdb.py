...
def imdb_callback(update, context):
    ...
    if user_id != int(data[1]):
        ...
        if imdb.get('poster'):
            ...
            app.send_photo(chat_id=query.message.reply_to_message.chat_id,  caption=cap, photo='https://te.legra.ph/file/df84bcfb822012635ff31.jpg', reply_markup=InlineKeyboardMarkup(buttons))
        message.delete()
    else:
        query.answer()
