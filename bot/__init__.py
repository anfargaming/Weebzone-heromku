...
if len(TGH_THUMB) == 0:
    TGH_THUMB = 'https://te.legra.ph/file/df84bcfb822012635ff31.jpg'
...
if len(START_BTN1_NAME) == 0 or len(START_BTN1_URL) == 0:
    ...
    START_BTN1_URL = 'https://t.me/KCxTG'

START_BTN2_NAME = environ.get('START_BTN2_NAME', '')
START_BTN2_URL = environ.get('START_BTN2_URL', '')
if len(START_BTN2_NAME) == 0 or len(START_BTN2_URL) == 0:
    START_BTN2_NAME = 'Request Group'
    START_BTN2_URL = 'https://t.me/KC_Filmz'
...
if len(GD_INFO) == 0:
    GD_INFO = 'Uploaded by KC Mirror Bot'
...
if len(IMAGE_URL) == 0:
    IMAGE_URL = 'https://te.legra.ph/file/df84bcfb822012635ff31.jpg'
